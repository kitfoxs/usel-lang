...
USEL molecules follow the same principle. The decompositions are not arbitrary; they capture *phenomenological* properties of the referent using only universal concepts.
...
| 3 | **TREE** | `[SOMETHING][LIVE][BIG][PART][ABOVE][BELOW]` | A *living thing* (not an artifact) that is *big*, and has *parts* both *above* (trunk, branches, canopy) and *below* (roots). The ABOVE+BELOW duality is the critical differentiator. |
| 4 | **SUN** | `[SOMETHING][BIG][VERY][FAR][ABOVE]` | A *thing* that is *very big*, *very far*, and *above*. The VERY intensifier on both BIG and FAR distinguishes it from MOON (which is SMALL, FAR, ABOVE). |
...
| 8 | **HEART** | `[BODY][PART][INSIDE][FEEL]` | A *body part* that is *inside* the body and associated with *feeling*. Cross-culturally, the heart is linked to emotion (English: "heartfelt"; Chinese: 心 xīn; Arabic: قلب qalb). |
...
2. **Contrastive differentiation** — Related molecules are distinguished by minimal prime substitutions:
   ...
   - SUN vs. MOON: `[BIG][VERY]` vs. `[SMALL]` — same spatial frame (FAR, ABOVE), different scale
...
- **RQ3:** Do children (ages 8–12) show comparable learning gains to adults after training?

### Participants

| Group | N | Age | Prior Knowledge |
|-------|---|-----|-----------------|
| **A: Children** | 20 | 8–12 | No linguistic or programming training |
...
| H2 | Post-training accuracy for Group C > 60% | 30 minutes of prime training enables majority comprehension |
...
| **Training efficiency** | Hypothesized: 30 min of prime training → >60% molecule comprehension |
...
| TREE | `[SOMETHING][LIVE][BIG][PART][ABOVE][BELOW]` | living thing, big, parts above and below |
| SUN | `[SOMETHING][BIG][VERY][FAR][ABOVE]` | something very big, very far, above |
